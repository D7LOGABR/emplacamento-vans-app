Faça a mesma coisa com esse código, altere ele para incluir a busca por placa mesmo?
        ...
        if not client_df.empty:
            ...
            if total_purchases > 1:
                ...
                if "AnoMesNum" in purchase_frequency.columns:
                    # Converter para numérico, coercing erros, e depois para Int64 para permitir NA
                    purchase_frequency["AnoMesNum"] = pd.to_numeric(purchase_frequency["AnoMesNum"], errors='coerce').astype('Int64')
                    # Remover NAs antes de ordenar
