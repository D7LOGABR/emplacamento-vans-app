...
<style>
    ...
    .info-card {background-color: #f8f9fa; border-radius: 8px; padding: 15px; margin-bottom: 10px; border-left: 5px solid #0055a4;}
    .info-card .label {font-weight: bold; color: #003366; display: block; margin-bottom: 3px;}
    .info-card .value {color: #333;}
    h1, h2, h3, h4 {color: #003366;}
    .stButton>button {background-color: #0055a4; color: white; border-radius: 5px; padding: 0.5rem 1rem;}
    .stButton>button:hover {background-color: #003366; color: white;}
    .stAlert p {font-size: 1rem;}
    .stMetric {background-color: #e9ecef; border-radius: 8px; padding: 10px 15px; border-left: 5px solid #6c757d;}
</style>
...
NOME_COLUNA_CONCESSIONARIO = "CONCESSIONÁRIO"  # Ajuste conforme o nome exato da sua planilha
...
def load_data(file_path_or_buffer):
    try:
        ...
        # Normalização da coluna CONCESSIONÁRIO (ajuste para o nome correto)
...
if search_button and search_query:
    ...
    if results_df.empty:
        ...
        if not client_df.empty:
            ...
            # NOVO: Modelo mais comprado e concessionário mais frequente
            ...
            # NOVO: Inclui o concessionário relacionado ao chassi
